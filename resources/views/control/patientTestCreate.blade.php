...
<div class="col-md-12">
	<div class="card card-user">
		<div class="card-header">
			<h5 class="card-title">Create Patient Test</h5>
		</div>
		<div class="card-body">
			<form method="post">
				@csrf
				<div class="row">
					...
					<div class="col-md-8 px-1 offset-2">
						<div class="form-group">
							...
							<input type="date" name="collection_date" class="form-control" placeholder="Collection Day">
						</div>
					</div>
					<div class="col-md-8 px-1 offset-2">
						<div class="form-group">
							<label>Delivery Date</label>
							<input type="date" name="delivery_date" class="form-control" placeholder="Day">
						</div>
					</div>
					<div class="col-md-8 px-1 offset-2">
						<div class="form-group">
				...
				<div class="row">
					<div class="update ml-auto mr-auto">
						<button class="btn btn-primary btn-round">Create Patient Test</button>
					</div>
				</div>
			</form>
		</div>
